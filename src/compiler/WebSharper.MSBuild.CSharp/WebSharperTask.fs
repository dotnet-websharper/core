...
//        let res = string builder
//        
//        printfn "ZafirCS arguments: %s" res
//
//        if this.CscCommandLineArgs <> null then
//            printfn "CSC arguments: %s" this.CscCommandLineArgs
...
//            use mutex = new System.Threading.Mutex(true, "WebSharper.MSBuild.CSharp", &createdNew)

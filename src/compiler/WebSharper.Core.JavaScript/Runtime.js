...
IntelliFactory = {
    Runtime: {
        ...
        //Define: function (target, name, base, init, cctor) {
        ...
        //            }
        //            typeFunction.prototype = proto;
        //            init(proto, typeFunction);
        //            Object.defineProperty(target, name, { value: typeFunction });
        //            if (cctor) { cctor() }
        //            return typeFunction;
        //        }
        //    });
...
IntelliFactory.Runtime.OnLoad(function () { WebSharper.Html.Client.Activator.Activate() });

...
type Optional<'T> =
    ...
    static member op_Implicit(x: 'T) = Defined x
...
type Union<'T1, 'T2> =
    ...
    static member op_Implicit(x: 'T1) = Union1Of2 x : Union<'T1, 'T2>
    static member op_Implicit(x: Union<'T1, 'T2>) = X<'T1>
    static member op_Implicit(x: 'T2) = Union2Of2 x : Union<'T1, 'T2>
...
type Union<'T1, 'T2, 'T3> =
    ...
    static member op_Implicit(x: 'T1) = Union1Of3 x : Union<'T1, 'T2, 'T3>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3>) = X<'T1>
    static member op_Implicit(x: 'T2) = Union2Of3 x : Union<'T1, 'T2, 'T3>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3>) = X<'T2>
    static member op_Implicit(x: 'T3) = Union3Of3 x : Union<'T1, 'T2, 'T3>
...
type Union<'T1, 'T2, 'T3, 'T4> =
    ...
    static member op_Implicit(x: 'T1) = Union1Of4 x : Union<'T1, 'T2, 'T3, 'T4>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4>) = X<'T1>
    static member op_Implicit(x: 'T2) = Union2Of4 x : Union<'T1, 'T2, 'T3, 'T4>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4>) = X<'T2>
    static member op_Implicit(x: 'T3) = Union3Of4 x : Union<'T1, 'T2, 'T3, 'T4>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4>) = X<'T3>
    static member op_Implicit(x: 'T4) = Union4Of4 x : Union<'T1, 'T2, 'T3, 'T4>
...
type Union<'T1, 'T2, 'T3, 'T4, 'T5> =
    ...
    static member op_Implicit(x: 'T1) = Union1Of5 x : Union<'T1, 'T2, 'T3, 'T4, 'T5>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5>) = X<'T1>
    static member op_Implicit(x: 'T2) = Union2Of5 x : Union<'T1, 'T2, 'T3, 'T4, 'T5>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5>) = X<'T2>
    static member op_Implicit(x: 'T3) = Union3Of5 x : Union<'T1, 'T2, 'T3, 'T4, 'T5>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5>) = X<'T3>
    static member op_Implicit(x: 'T4) = Union4Of5 x : Union<'T1, 'T2, 'T3, 'T4, 'T5>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5>) = X<'T4>
    static member op_Implicit(x: 'T5) = Union5Of5 x : Union<'T1, 'T2, 'T3, 'T4, 'T5>
...
type Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6> =
    ...
    static member op_Implicit(x: 'T1) = Union1Of6 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>) = X<'T1>
    static member op_Implicit(x: 'T2) = Union2Of6 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>) = X<'T2>
    static member op_Implicit(x: 'T3) = Union3Of6 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>) = X<'T3>
    static member op_Implicit(x: 'T4) = Union4Of6 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>) = X<'T4>
    static member op_Implicit(x: 'T5) = Union5Of6 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>) = X<'T5>
    static member op_Implicit(x: 'T6) = Union6Of6 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>
...
type Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7> =
    ...
    static member op_Implicit(x: 'T1) = Union1Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>) = X<'T1>
    static member op_Implicit(x: 'T2) = Union2Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>) = X<'T2>
    static member op_Implicit(x: 'T3) = Union3Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>) = X<'T3>
    static member op_Implicit(x: 'T4) = Union4Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>) = X<'T4>
    static member op_Implicit(x: 'T5) = Union5Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>) = X<'T5>
    static member op_Implicit(x: 'T6) = Union6Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>
    static member op_Implicit(x: Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>) = X<'T6>
    static member op_Implicit(x: 'T7) = Union7Of7 x : Union<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>

...
[<Sealed>]
type FormletTestRenderEvents () =
    inherit Web.Control()
    [<JavaScript>]
    override this.Body =
        upcast Div [FormletTest.TestRenderEvents]
        

[<Sealed>]
type FormleTestReadOnly() =
    inherit Web.Control()
    [<JavaScript>]
    override this.Body =

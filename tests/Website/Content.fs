...
let TestsPage runServerTests autoStart (ctx: Context<FullAction>) =
    ...
    let l = [ 1 ]
    let r = { Client.A = 1 }
    let c = Client.SimpleClass [| "Hello"; "world" |]
    let jsonBaseUri =
        Tests.Json.String ""
    ...
    Content.Page(
        ...
        Body = (
            [
                ...
                yield Web.InlineControl ( Client.ClientSideClassTest c ) :> Web.Control
                yield Web.InlineControl ( WebSharper.Html5.Tests.Main.RunTests() ) :> Web.Control

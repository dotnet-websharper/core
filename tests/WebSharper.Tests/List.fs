...
let Tests =
    ...
    Section "List" {
        ...
        Test "List.append" {
            ...
            forRandom 100 (R.Tuple2Of (R.ListOf R.Int, R.ListOf R.Int))
                (fun (x, y) -> Do {
        ...
        Test "List.fold2" {
            ...
            forRandom 100 (R.ListOf (R.Tuple2Of (R.Int,R.Boolean))) (fun x -> Do {
        ...
        Test "List.map" {
            ...
            forRandom 100 (R.Tuple3Of(R.ListOf R.Int,
                                       R.OneOf funcs,
                                       R.OneOf funcs))
                (fun (x, f1, f2) -> Do {
                    let map1 = x
        ...
        Test "List.reduceBack" {
            ...
            forRandom 100 (R.ListOf R.Int) (fun x ->
        ...
        Test "List.zip" {
            ...
            forRandom 100 (R.ListOf (R.Tuple2Of (R.Int, R.Int))) (fun l -> Do {

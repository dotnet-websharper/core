...
module internal CodeDom =
    ...
    let TryFindNamespace (p: CodeCompileUnit) (name: string) : option<CodeNamespace> =
    ...
    let TryFindType (p: CodeCompileUnit) (ns: string) (name: string) : option<CodeTypeDeclaration> =
    ...
    let GetType (p: CodeCompileUnit) (ns: string) (name: string) : CodeTypeDeclaration =
    ...
    let GenerateCodeFromAttributeDeclaration (provider: CodeDomProvider) (attr: CodeAttributeDeclaration) =
    ...
    let AnnotateProperty (provider: CodeDomProvider) (indentation: int)
        (getter: list<CodeAttributeDeclaration>) (setter: list<CodeAttributeDeclaration>) (prop: CodeMemberProperty) =
        use buffer = new StringWriter()
